...
const sql_server_functions = require("./sql-server-functions");
...
const _create = async (req, res, next) => {
  ...
  if (!validParams) {
    ...
    try {
      var result = await sql_server_functions.create_city(req.body);
...
const _retrieve = async (req, res, next) => {
  try {
    var result = await sql_server_functions.retrieve_city(req.params.ZipCode);
...
const _update = async (req, res, next) => {
  ...
  if (!validParams) {
    ...
    try {
      var result = await sql_server_functions.update_city(req.params.ZipCode, req.body);
...
const _delete = async (req, res, next) => {
  try {
    var result = await sql_server_functions.delete_city(req.params.ZipCode);
